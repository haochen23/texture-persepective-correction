...
if __name__ == '__main__':
    ...
    image_path = '../dataset/processed/val/distorted/projective_000008.jpg'
    flow_path = '../dataset/processed/val/flow/projective_000008.mat'

    distortedImg = np.array(Image.open(image_path).convert('RGB'))
